class CreateEventPrefectures < ActiveRecord::Migration[5.2]
  def change
    create_table :event_prefectures do |t|
      t.integer :event_id, null:false  #イベントID
      t.integer :total, null:false  #総増減数
